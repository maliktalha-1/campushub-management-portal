    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-16 px-6 lg:flex-row">
        ...
        >
          ...
          {/* Highlights */}
        <div className="mt-10 flex flex-wrap gap-4">
        <div className="flex items-center gap-2 rounded-full border border-blue-100 bg-white dark:bg-slate-900 px-4 py-2 shadow-sm">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <div className="rounded-3xl border bg-white dark:bg-slate-900 p-8 shadow-2xl">
...
function DashboardCard({
  ...
  return (
    <div className="rounded-2xl border bg-white dark:bg-slate-900 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
